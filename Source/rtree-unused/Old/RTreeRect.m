...
-----------------------------------------------------------------------------*/
void RTreeInitRect(RTreeRect *R)
{
...
-----------------------------------------------------------------------------*/
void RTreeRandomRect(RTreeRect *R)
{
	register RTreeRect *r = R;
	register NSInteger i;
...
-----------------------------------------------------------------------------*/
void RTreeSearchRect(RTreeRect *Search, RTreeRect *Data)
{
	register RTreeRect *search = Search, *data = Data;
...
-----------------------------------------------------------------------------*/
void RTreePrintRect(RTreeRect *R, NSInteger depth)
{
	register RTreeRect *r = R;
	register NSInteger i;
	assert(r);
...
-----------------------------------------------------------------------------*/
RectReal RTreeRectVolume(RTreeRect *R)
{
	register RTreeRect *r = R;
	register NSInteger i;
 ...
 */
RectReal RTreeRectSphericalVolume(RTreeRect *R)
{
	register RTreeRect *r = R;
	register NSInteger i;
...
-----------------------------------------------------------------------------*/
RectReal RTreeRectSurfaceArea(RTreeRect *R)
{
	register RTreeRect *r = R;
	register NSInteger i, j;
...
-----------------------------------------------------------------------------*/
RTreeRect RTreeCombineRect(RTreeRect *R, RTreeRect *Rr)
{
	register RTreeRect *r = R, *rr = Rr;
	register NSInteger i, j;
	RTreeRect new_rect;
	NSCParameterAssert(r && rr);
...
-----------------------------------------------------------------------------*/
NSInteger RTreeOverlap(RTreeRect *aRect, RTreeRect *bRect)
{
...
{
	register RTreeRect *r = R, *s = S;
	register NSInteger i, j;
	NSCParameterAssert(r && s);
...
-----------------------------------------------------------------------------*/
NSInteger RTreeContained(RTreeRect *R, RTreeRect *S)
{
	register RTreeRect *r = R, *s = S;
	register NSInteger i, j, result;
	NSCParameterAssert((NSInteger)r && (NSInteger)s);
